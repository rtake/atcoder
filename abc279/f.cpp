...
int main() {
  ...
  UnionFind uf(n+q); // ball
  vector<ll> root(n+q,-1); // box
  ...
  rep(i,q) {
    ...
    if(c == 1LL) {
      ...
      ans.push_back(root[uf.find(x)]+1);
  ...
  rep(i,n+q) cout<<uf.find(i)<<" "; cout<<endl;
  rep(i,n+q) cout<<root[i]<<" "; cout<<endl;
