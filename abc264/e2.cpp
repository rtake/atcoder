...
int main() {
  ...
  rep(i,e) {
    ...
    ll _u=u[i];
    ll _v=v[i];
    ll u_light=light[uf.find(_u)];
    ll v_light=light[uf.find(_v)];

    if(u_light == 1LL && v_light == 1LL) {
